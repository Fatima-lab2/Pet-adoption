    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('add_food') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" id="quantity" name="quantity" class="form-control" min="1" value="{{ old('quantity') }}" required>
            </div>
            
            <div class="form-group">
                <label for="expire_date">Expiration Date:</label>
                <input type="date" id="expire_date" name="expire_date" class="form-control" min="{{ date('Y-m-d') }}" value="{{ old('expire_date') }}" required>
            </div>
